      ...
      <div class="settings-content">
        ...
        <div class="settings-section">
          ...
          <div class="setting-item">
            ...
            <input type="number" id="highTemp" value="${
              this.settings.alerts.highTemp
            }">
          </div>
          <div class="setting-item">
            <label>Low Temperature Alert (°F)</label>
            <input type="number" id="lowTemp" value="${
              this.settings.alerts.lowTemp
            }">
          </div>
          <div class="setting-item">
            <label>Wind Speed Alert (mph)</label>
            <input type="number" id="windSpeed" value="${
              this.settings.alerts.windSpeed
            }">
          </div>
        </div>
        ...
        <div class="settings-section">
          ...
          <div class="setting-item">
            ...
            <select id="tempUnit">
              <option value="F" ${
                this.settings.display.temperature === "F" ? "selected" : ""
              }>Fahrenheit</option>
              <option value="C" ${
                this.settings.display.temperature === "C" ? "selected" : ""
              }>Celsius</option>
            </select>
          </div>
        </div>
